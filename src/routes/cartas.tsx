...
const cartas = [
  ...
  { numeral: "VIII", title: "Recuerdos", content: "Cada momento contigo se convierte en mi recuerdo favorito. Las risas, las aventuras, incluso los silencios juntos... todo es perfecto cuando estoy a tu lado. A veces me pongo a pensar en todo lo que hemos vivido y me doy cuenta que no son solo momentos, es historia. Me gusta volvera a esos recuerdos, porque en cada uno estás tú y en cada uno encuentro una razón para quererte mucho más. Y saber que aún nos quedan muchos más por crear me hace sentir realmente feliz. Más momentos, más historias, más recuerdos que algun dia miraré atrás y volveran a hacerme sonreir. Porque algo que si tengo claro, es que mis recuerdos favoritos... siempre te incluyen a tí. Te amo infinitamente." },
  { numeral: "IX", title: "Latidos", content: "Eres mi primer pensamiento al despertar y el último antes de dormir. Ese ritmo constante que me recuerda que estoy vivo. Cuando estoy contigo, todo se calma, pero al mismo tiempo mi corazón late distinto, más fuerte, más sincero. Como si supiera que está donde quiere estar. Y cuando no estás, hay algo que te extraña en silencio, algo que te busca incluso sin palabras, como si cada latido intentara acercarme a tí. No hay palabras suficientes para describir lo que siento, pero mientras mi corazón siga latiendo intentaré demostrártelo cada día y voy a seguir eligiendote." },
