...
const cartas = [
  ...
  { numeral: "X", title: "Eternidad", content: "Tenemos una promesa, una la cual nos une. La eternidad. Te amo en esta tierra, en cada dia que compartimos, en cada momento que vivimos. Pero mi amor no se queda ahí y cuando seamos raptados y todo lo terrenal quede atrás, mi amor seguirá intacto. Porque mi amor no depende del tiempo, ni el lugar, sino de lo que eres tú para mi. Te seguiré amando más allá de lo que conocemos porque de lo que si tengo claro, es que Dios nos unió y tú serás mi compañia eterna y yo la tuya. No es solo una promesa...es una certeza.  Estaremos juntos hoy y por la eternidad. Te amo eternamente. ♥" },
];
